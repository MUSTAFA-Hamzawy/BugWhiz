  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(`${process.env.REACT_APP_BUGWHIZ_API_URL}/api/project/analytics`,{
          params: {
            projectID: projectId
          },
          headers: {
    ...
    <Box sx={{ p: 4 }}>
      ...
      <Grid container spacing={4}>
        <Grid item xs={12} md={6}>
          <Typography variant="h6" className={styles.branchName}>Issue Status</Typography>
        ...
        <Grid item xs={12} md={6}>
          <Typography variant="h6" className={styles.branchName}>Issue Priority</Typography>
          <ResponsiveContainer width="100%" height={300}>
        ...
        <Grid item xs={12} md={6}>
          <Typography variant="h6" className={styles.branchName}>Issue Category</Typography>
          <ResponsiveContainer width="100%" height={300}>
        ...
        <Grid item xs={12} md={6}>
          <Typography variant="h6" className={styles.branchName}>Issue Status Distribution</Typography>
          <ResponsiveContainer width="100%" height={300}>
            <PieChart>
              <Pie 
                data={statusData} 
        ...
        <Grid item xs={12} md={6}>
          <Typography variant="h6" className={styles.branchName}>Issue Priority Distribution</Typography>
          <ResponsiveContainer width="100%" height={300}>
            <PieChart>
              <Pie 
                data={priorityData} 
        ...
        <Grid item xs={12} md={6}>
          <Typography variant="h6" className={styles.branchName}>Issue Category Distribution</Typography>
          <ResponsiveContainer width="100%" height={300}>
            <PieChart>
              <Pie 
                data={categoryData} 
        ...
        {developers.map((developer) => (
          <Grid item xs={12} md={6} key={developer._id}>
            <Typography variant="h6" className={styles.branchName}>{developer.fullName} - Issues Statistics</Typography>
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={[
