...
class TestSignup(unittest.TestCase):
    ...
    def test_signup_success(self):
        self.signup_page.enter_fullname("KarimMahmou")
        self.signup_page.enter_username("karimmohamed2222")
        self.signup_page.enter_email("karimmohamed2222@gmail.com")
        self.signup_page.enter_phone("01113162152")
    ...
    def test_signup_with_mismatched_passwords(self):
        ...
        self.assertEqual(self.driver.current_url, BASE_URL + "/signup")
        self.assertEqual("Sign UP - BugWhiz", self.driver.title)
        self.assertEqual(self.signup_page.get_confirm_password_mismatch_error(), "Confirm password and password should be the same")
    ...
    def test_signup_with_invalid_email_format(self):
        ...
        self.assertEqual(self.driver.current_url, BASE_URL + "/signup")
        self.assertEqual("Sign UP - BugWhiz", self.driver.title)
        self.assertEqual(self.signup_page.get_email_invalid_error(), "This is not a valid email format!")
    ...
    def test_signup_with_short_password(self):
        ...
        self.assertEqual(self.driver.current_url, BASE_URL + "/signup")
        self.assertEqual("Sign UP - BugWhiz", self.driver.title)
        self.assertEqual(self.signup_page.get_password_short_error(), "Password must be more than 4 characters")        
