...
def extract_ticket_descriptions(json_file_path):
    # Read the JSON file
...
def extract_new_bug_description(json_file_path):
    # Read the JSON file
    with open(json_file_path, 'r') as file:
        data = json.load(file)
...
if __name__ == "__main__":
    ...
    # the input is a json file containing the project tickets
    #json_file_path = sys.argv[1]
    json_file_path = 'bugs.json'

    # 2- Extract the ticket descriptions from the json file
    ticket_descriptions = extract_ticket_descriptions(json_file_path)
    ...
    new_bug = extract_new_bug_description(json_file_path)
