...
class QuintetWeights(Layer):
    ...
    # the build method initializes the weight matrix of the QuintetWeights layer 
    # and ensures that the layer is marked as built. 
    ...
    # the forward pass computation for the custom layer.
    def call(self, x):
        x = tf.reshape(x, (1, 1))
...
def quintet_loss(inputs):
    ...
    # Compute the mask.
    # A tiled version of the pairwise distance matrix 
